...
const META: Record<AppViewMode, PageMeta> = {
  ...
  'ai-videos': { titleEn: 'AI Astrology Videos | CosmicJyoti', titleHi: 'AI ज्योतिष वीडियो | CosmicJyoti', descriptionEn: 'Short daily AI videos on planets, Nakshatra, Kundali, Muhurat and more.', descriptionHi: 'ग्रह, नक्षत्र, कुंडली, मुहूर्त पर दैनिक AI वीडियो।' },
